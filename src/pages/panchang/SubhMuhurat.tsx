...
const abhijitMuhurat2026 = [
    ...
    { date: 'Mar 14, 2026', day: 'Saturday', start: '22:27', end: '6:30 AM (15 March)' },
    { date: 'Apr 11, 2026', day: 'Saturday', start: '7:12', end: '15:21' },
    { date: '8 May 2026', day: 'Friday', start: '2:44 PM', end: '11:04 PM' },
    { date: '4 June 2026', day: 'Thursday', start: '9:04 PM', end: '5:26 AM (5 June)' },
    { date: '2 July 2026', day: 'Thursday', start: '2:50 AM', end: '11:11 AM' },
    { date: '29 July 2026', day: 'Wednesday', start: '9:05 AM', end: '5:20 PM' },
    { date: '25 August 2026', day: 'Tuesday', start: '4:18 PM', end: '12:35 AM (26 August)' },
    { date: '22 September 2026', day: 'Tuesday', start: '12:33 AM', end: '8:50 AM' },
    { date: '19 October 2026', day: 'Monday', start: '8:59 AM', end: '5:20 PM' },
    { date: '15 November 2026', day: 'Sunday', start: '4:44 PM', end: '1:15 AM (16 November)' },
    { date: '12 December 2026', day: 'Saturday', start: '11:27 PM', end: '8:00 AM (13 December)' }
];
...
const getShubhMuhuratData = (city: string) => {
    ...
    return {
        ...
        abhijitEnd: endTime,
        duration: '56 minutes',
        description: 'Abhijit Muhurat is the 8th muhurat of the day, associated with victory and success.',
...
export default function ShubhMuhurat() {
    ...
    const [muhuratData, setMuhuratData] = useState(getShubhMuhuratData('New Delhi, Delhi, India'));
                ...
                <Reveal delay={0.3}>
                    <div className="max-w-3xl mx-auto">
                        <p className="text-base text-ink-600 leading-relaxed">
                            In Hinduism, time is of great value as it rules all aspects of life, nature, and cosmic cycles. 
                            When you do an important task at the right moment, it can yield incredibly successful results. 
                            <span className="font-semibold text-primary-600"> Shubh Muhurat</span> and 
                            <span className="font-semibold text-primary-600"> Abhijit Muhurat</span> are carefully 
                            observed for important activities.
                        </p>
                    </div>
                </Reveal>
            </div>
                    ...
                    <Reveal>
                        ...
                        <div className="bg-gradient-to-br from-ink-50 to-primary-50 rounded-2xl p-6 md:p-8 border border-ink-100">
                            ...
                            <div className="text-center mb-6">
                                <h2 className="text-2xl font-bold text-ink-900">{muhuratData.city}</h2>
                            ...
                            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-6 border-2 border-amber-300 mb-6 text-center">
                                <div className="flex items-center justify-center gap-2 mb-2">
                                    ...
                                    <span className="text-lg font-bold text-amber-700">Abhijit Muhurat Today</span>
                                </div>
                                <div className="text-2xl md:text-3xl font-bold text-amber-700">
                                    {muhuratData.abhijitStart} â€“ {muhuratData.abhijitEnd}
                                </div>
                                <p className="text-sm text-amber-600 mt-2">
                                    Duration: {muhuratData.duration} â€¢ Associated with victory and success
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-4">
                                <div className="bg-white rounded-xl p-4 text-center border border-ink-100">
                                    ...
                                    <div className="text-sm font-bold text-ink-900">{muhuratData.sunrise}</div>
                                </div>
                                <div className="bg-white rounded-xl p-4 text-center border border-ink-100">
                                    <Sunset className="h-6 w-6 text-orange-600 mx-auto mb-1" />
                                    <div className="text-xs text-ink-500">Sunset</div>
                                    <div className="text-sm font-bold text-ink-900">{muhuratData.sunset}</div>
                                </div>
                            </div>

                            {/* Description */}
                            <div className="bg-white rounded-xl p-4 border border-ink-100">
                                <p className="text-sm text-ink-600 leading-relaxed">{muhuratData.description}</p>
                            </div>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gradient-to-r from-amber-600 to-yellow-600">
                                        <th className="text-left py-3 px-4 text-white font-semibold text-sm">Date</th>
                                        <th className="text-left py-3 px-4 text-white font-semibold text-sm">Day</th>
                                        <th className="text-left py-3 px-4 text-white font-semibold text-sm">Start Time</th>
                                        <th className="text-left py-3 px-4 text-white font-semibold text-sm">End Time</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {abhijitMuhurat2026.map((item, i) => (
                                        <tr key={i} className={i % 2 === 0 ? 'bg-ink-50' : 'bg-white'}>
                                            <td className="py-3 px-4 text-sm text-ink-900 font-semibold">{item.date}</td>
                                            <td className="py-3 px-4 text-sm text-ink-600">{item.day}</td>
                                            <td className="py-3 px-4 text-sm text-ink-600">{item.start}</td>
                                            <td className="py-3 px-4 text-sm text-ink-600">{item.end}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                    ...
                    <div className="mt-4 max-w-6xl mx-auto">
                        <div className="bg-accent-50 rounded-2xl p-4 border border-accent-200">
                            <p className="text-sm text-ink-700 text-center">
                                <span className="font-semibold">ðŸ’¡ Note:</span> Abhijit Muhurat and Abhijit Nakshatra 
                                are not the same, but when they occur together, it is considered highly auspicious.
                            </p>
                        </div>
                    </div>
                </Reveal>
                    ...
                    <Reveal delay={0.1}>
                        <div className="bg-ink-50 rounded-2xl p-8 border border-ink-100 w-full">
                            <p className="text-ink-700 leading-relaxed mb-6">
                                To understand and calculate Abhijit Muhurat today, you must first check the sunrise 
                                and sunset timings of your location. In Delhi NCT, the sunrise time is around 05:24 AM 
                                and the sunset time is around 07:24 PM.
                            </p>

                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="bg-white rounded-xl p-6 border border-ink-100">
                                    <h4 className="text-lg font-bold text-ink-900 mb-3">Step-by-Step Calculation</h4>
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3 text-sm text-ink-600">
                                            <span className="text-primary-600 font-bold">1.</span>
                                            <span>Difference between sunrise and sunset = <span className="font-semibold">14 hours (840 minutes)</span></span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-ink-600">
                                            <span className="text-primary-600 font-bold">2.</span>
                                            <span>Divide by 15 = <span className="font-semibold">56 minutes</span> per muhurat</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-ink-600">
                                            <span className="text-primary-600 font-bold">3.</span>
                                            <span>8th muhurat: Add 7 parts (7 Ã— 56 = 392 minutes) to sunrise</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-ink-600">
                                            <span className="text-primary-600 font-bold">4.</span>
                                            <span>Start time = <span className="font-semibold text-primary-600">11:56 AM</span></span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-ink-600">
                                            <span className="text-primary-600 font-bold">5.</span>
                                            <span>End time = <span className="font-semibold text-primary-600">12:52 PM</span></span>
                                        </li>
                                    </ul>
                                </div>

                                <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-6 border border-amber-200">
                                    <h4 className="text-lg font-bold text-ink-900 mb-3">Duration and Variation</h4>
                                    <div className="space-y-3">
                                        <div className="bg-white rounded-lg p-3 border border-amber-100">
                                            <p className="text-sm text-ink-600">
                                                <span className="font-semibold">Duration:</span> 48 to 56 minutes
                                            </p>
                                        </div>
                                        <div className="bg-white rounded-lg p-3 border border-amber-100">
                                            <p className="text-sm text-ink-600">
                                                <span className="font-semibold">Depends on:</span> Length of the day at a particular location
                                            </p>
                                        </div>
                                        <div className="bg-white rounded-lg p-3 border border-amber-100">
                                            <p className="text-sm text-ink-600">
                                                <span className="font-semibold">Varies by:</span> Daily sunrise and sunset times
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-6 p-4 bg-primary-50 rounded-xl border border-primary-200">
                                <p className="text-sm text-ink-700">
                                    <span className="font-semibold">âœ¨ Example:</span> In Delhi, Abhijit Muhurat today is 
                                    approximately from <span className="font-bold text-primary-600">11:56 AM to 12:52 PM</span>.
                                </p>
                            </div>
                        </div>
                    </Reveal>
        ...
        <section className="py-16 bg-ink-50">
            <div className="container-8xl">
                ...
                <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
                    {muhuratData.auspiciousActivities.map((activity: string, i: number) => (
            ...
            <div className="container-8xl">
                ...
                <Reveal delay={0.3}>
                    <div className="mt-6 max-w-4xl mx-auto">
                        <div className="bg-accent-50 rounded-2xl p-4 border border-accent-200">
                            <p className="text-sm text-ink-700 text-center">
                                <span className="font-semibold">ðŸ’¡ Note:</span> In some customs, Wednesday is not 
                                considered auspicious. Hence, starting important work should be avoided on this day, 
                                even during Abhijit Muhurat. For major Manglik activities, consult an astrologer.
                            </p>
                        </div>
                    </div>
                </Reveal>
    ...
    const significanceItems = [
        {
            ...
            description: 'Abhijit Muhurat is very important in Hindu tradition and is considered during festivals and religious rituals.'
        },
        {
            icon: Crown,
            title: 'Victory & Success',
            description: 'The word Abhijit means victorious or winner, which is why this muhurat is often chosen for important activities and new beginnings.'
        },
        {
            icon: Sun,
            title: 'Midday Energy',
            description: 'It occurs around midday when the Sun is at its highest point, carrying strong and positive energy.'
        }
    ];
                        ...
                        <div className="bg-ink-50 rounded-2xl p-8 border border-ink-100 w-full">
                            <div className="grid md:grid-cols-3 gap-6">
                                <div className="bg-white rounded-xl p-6 border border-ink-100 text-center">
                                    ...
                                    <h4 className="text-lg font-bold text-ink-900 mb-2">Victory</h4>
                                    <p className="text-sm text-ink-500">
                                        The word Abhijit means "winner" or "victorious," making it ideal for new beginnings.
                                    </p>
                                </div>
                                <div className="bg-white rounded-xl p-6 border border-ink-100 text-center">
                                    <div className="text-4xl mb-3">â˜€ï¸</div>
                                    <h4 className="text-lg font-bold text-ink-900 mb-2">Midday Power</h4>
                                    <p className="text-sm text-ink-500">
                                        Occurs around midday when the Sun is at its highest point, carrying strong positive energy.
                                    </p>
                                </div>
                                <div className="bg-white rounded-xl p-6 border border-ink-100 text-center">
                                    <div className="text-4xl mb-3">ðŸ•‰ï¸</div>
                                    <h4 className="text-lg font-bold text-ink-900 mb-2">Divine Blessings</h4>
                                    <p className="text-sm text-ink-500">
                                        Believed to have the blessings of Lord Vishnu, helping remove obstacles.
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    const myths = [
        {
            ...
            description: 'It is believed that Lord Shiva defeated Tripurasura during the Abhijit Muhurat. Hence, it is associated with victory and winning.'
        },
        {
            icon: Crown,
            title: 'Lord Rama\'s Birth',
            description: 'Lord Rama is said to have been born during this favourable time period, making it all the more special.'
        },
        {
            icon: Star,
            title: 'Lord Vishnu\'s Blessings',
            description: 'This muhurat is believed to have the blessings of Lord Vishnu, who helps remove obstacles and reduce the effects of various doshas.'
        },
        {
            icon: Moon,
            title: 'The 28th Nakshatra',
            description: 'Abhijit was once considered the 28th nakshatra. It was later removed from the main nakshatra cycle and given a special daily time called Abhijit Muhurat.'
        }
    ];
                        ...
                        <Reveal key={myth.title} delay={i * 0.1}>
                            <div className="bg-white rounded-2xl p-6 border border-ink-100 hover:border-amber-200 hover:shadow-lg transition-all">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-ink-900 mb-2">{myth.title}</h3>
                                        <p className="text-sm text-ink-500 leading-relaxed">{myth.description}</p>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
            ...
            <div className="relative container-8xl text-center">
                ...
                <Reveal delay={0.1}>
                    <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
                        Find Today's <span className="gradient-text-light">Shubh Muhurat</span>
                    </h2>
                </Reveal>

                <Reveal delay={0.2}>
                    <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
                        Check auspicious timings for your location and plan important activities accordingly.
                    </p>
                </Reveal>

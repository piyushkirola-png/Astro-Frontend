...
const getTomorrowPanchang = (city: string) => {
    ...
    const date = tomorrow.toLocaleDateString('en-IN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' });
    ...
    return {
        ...
        tarabalam: ['Ashwini', 'Rohini', 'Aadra', 'Pushya', 'Magha', 'Hasta', 'Swati', 'Anuradha', 'Mula', 'Shravana', 'Shatabhisha', 'Uttara Bhadrapada'],
        chandrabalam: ['Ashwini', 'Rohini', 'Aadra', 'Pushya', 'Magha', 'Hasta', 'Swati', 'Anuradha', 'Mula', 'Shravana', 'Shatabhisha', 'Uttara Bhadrapada'],
        planets: [
            { name: 'Ascendant', rashi: 'Leo', longitude: '22Â°9â€²49â€³', nakshatra: 'Purva Phalguni', pada: '3' },
            { name: 'SUN', rashi: 'Leo', longitude: '23Â°6â€²33â€³', nakshatra: 'Purva Phalguni', pada: '3' },
            { name: 'MOON', rashi: 'Leo', longitude: '8Â°39â€²55â€³', nakshatra: 'Magha', pada: '3' },
            { name: 'MERCURY', rashi: 'Virgo', longitude: '4Â°39â€²0â€³', nakshatra: 'Uttara Phalguni', pada: '3' },
            { name: 'VENUS', rashi: 'Libra', longitude: '5Â°33â€²35â€³', nakshatra: 'Chitra', pada: '4' },
            { name: 'MARS', rashi: 'Gemini', longitude: '24Â°49â€²25â€³', nakshatra: 'Punarvasu', pada: '2' },
            { name: 'JUPITER', rashi: 'Cancer', longitude: '21Â°19â€²57â€³', nakshatra: 'Ashlesha', pada: '2' },
            { name: 'SATURN', rashi: 'Pisces', longitude: '18Â°53â€²36â€³', nakshatra: 'Revati', pada: '1' },
            { name: 'RAHU', rashi: 'Aquarius', longitude: '4Â°35â€²37â€³', nakshatra: 'Dhanishta', pada: '4' },
            { name: 'KETU', rashi: 'Leo', longitude: '4Â°35â€²37â€³', nakshatra: 'Magha', pada: '2' }
        ]
    };
};
...
export default function TomorrowPanchang() {
    ...
    const [panchangData, setPanchangData] = useState(getTomorrowPanchang('New Delhi, Delhi, India'));
                ...
                <Reveal delay={0.3}>
                    <div className="max-w-3xl mx-auto">
                        <p className="text-base text-ink-600 leading-relaxed">
                            Plan your tomorrow with cosmic guidance. Check auspicious timings, planetary positions, 
                            and key astrological details for <span className="font-semibold text-primary-600">tomorrow's Panchang</span> 
            ...
            <div className="relative container-8xl text-center">
                ...
                <Reveal delay={0.1}>
                    <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
                        Plan Tomorrow with <span className="gradient-text-light">Cosmic Wisdom</span>
                    </h2>
                </Reveal>

                <Reveal delay={0.2}>
                    <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
                        Check tomorrow's Panchang to plan your day with astrological guidance and auspicious timings.
                    </p>
                </Reveal>

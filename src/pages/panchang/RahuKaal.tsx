...
export default function RahuKaal() {
  ...
  const [panchangData, setPanchangData] = useState(
    getRahuKaalData("New Delhi, Delhi, India"),
  );
        ...
        <Reveal delay={0.3}>
          <div className="max-w-3xl mx-auto">
            <p className="text-base text-ink-600 leading-relaxed">
              Rahu Kaal is a 90-minute period considered inauspicious in Vedic
              astrology. This time is governed by planet{" "}
              <span className="font-semibold text-primary-600">Rahu</span>, a
              shadow planet believed to create obstacles to new beginnings.
                ...
                <div className="grid sm:grid-cols-2 gap-2">
                  {panchangData.inauspiciousTimings.map(
                    (timing: any, i: number) => (
                      <div
                        key={i}
                        className={`rounded-lg p-3 border ${timing.name === "Rahu Kaal" ? "bg-red-100 border-red-300" : "bg-red-50 border-red-200"}`}
                      >
                        <div
                          className={`text-xs font-semibold ${timing.name === "Rahu Kaal" ? "text-red-800" : "text-red-700"}`}
                        >
                          {timing.name}
                        </div>
                        <div
                          className={`text-xs ${timing.name === "Rahu Kaal" ? "text-red-700 font-semibold" : "text-red-600"}`}
                        >
                          {timing.time}
                        </div>
                      </div>
  ...
  const steps = [
    {
      ...
      description:
        "Get the precise sunrise and sunset times for your location.",
    },
    {
      number: 2,
      title: "Divide the total time span by 8",
      description:
        "Calculate the duration between sunrise and sunset, then divide by 8 to get each slot duration.",
    },
    {
      number: 3,
    ...
    },
    {
      ...
      description:
        "The designated slot for that day becomes the Rahu Kaal period.",
    },
  ];
            ...
            <div>
              <Reveal delay={0.3}>
                <div className="bg-white rounded-2xl p-6 border border-ink-100">
                  <h3 className="text-lg font-bold text-ink-900 mb-4 text-center">
                  ...
                  <div className="space-y-2">
                    {daySlots.map((item) => (
                      <div
                        key={item.day}
                        className="flex justify-between items-center p-2 bg-ink-50 rounded-lg"
                      >
              ...
              <Reveal delay={0.4}>
                <div className="mt-4 bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-4 border border-accent-200">
                  ...
                  <div className="text-sm text-ink-600 space-y-1">
                    <p>
                      <span className="font-semibold">Sunrise:</span> 5:35 AM
                    </p>
                    <p>
                      <span className="font-semibold">Sunset:</span> 6:15 PM
                    </p>
                    <p>
                      <span className="font-semibold">Total time:</span> 760
                      minutes
                    </p>
                    <p>
                      <span className="font-semibold">Slot duration:</span> 95
                      minutes
                    </p>
                    <p>
                      <span className="font-semibold">Day:</span> Monday â†’ 2nd
                      slot
                    </p>
                    <div className="mt-2 p-2 bg-white rounded-lg border border-ink-100">
                      <p className="font-bold text-primary-600">
                        Rahu Kaal: 7:10 AM â€“ 8:45 AM
                      </p>
                    </div>
                  </div>
                </div>
...
function WhatToAvoid() {
  const avoidItems = [
    ...
    },
    {
      ...
      description:
        "Avoid investing, lending money, or making financial commitments",
    },
    {
      icon: ShoppingBag,
      title: "New Purchases",
      description:
        "Avoid purchasing jewellery, electronics, property, or vehicles",
    },
    {
      icon: Activity,
          ...
          <div className="mt-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl p-6 border border-red-200">
              <p className="text-sm text-ink-700 text-center">
                <span className="font-semibold">ðŸ’¡ Note:</span> Rahu Kaal is
                not a caution or danger zone where you cannot resume your daily
                activities, but a period to{" "}
                <span className="font-semibold text-red-600">
                  avoid new beginnings or key events
                </span>
                .
              </p>
            </div>
      ...
      <div className="relative container-8xl text-center">
        ...
        <Reveal delay={0.2}>
          <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
            Check Rahu Kaal timings for your location and plan your day
            accordingly.
          </p>
        </Reveal>

...
const benefits = [
  {
    ...
    desc: "Understand your love life and compatibility.",
  },
  {
    icon: Briefcase,
    title: "Career Guidance",
    desc: "Navigate your professional path with clarity.",
  },
  {
    icon: TrendingUp,
    title: "Financial Outlook",
    desc: "Get insights on wealth and prosperity.",
  },
  {
    icon: Activity,
    title: "Health & Wellness",
    desc: "Stay aware of your well-being.",
  },
  {
    icon: Home,
    title: "Family Harmony",
    desc: "Bring peace and balance to family life.",
  },
  {
    icon: Baby,
    title: "Children & Education",
    desc: "Guidance for your children's future.",
  },
];
            ...
            {horoscopeTypes.map((type, i) => (
              <Reveal key={type.title} delay={i * 0.1}>
                <div className="group h-full bg-ink-50 rounded-2xl p-8 border border-ink-100 hover:border-accent-300 hover:bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
                  <div
                    className={`p-4 rounded-xl bg-gradient-to-br ${type.color} w-fit mx-auto mb-5 group-hover:scale-110 transition-transform`}
                  >
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Get your personalized horoscope today and discover what the stars

...
const astrologers = [
  ...
  },
  {
    ...
    expertise: "Marriage Compatibility",
    experience: "20+ years",
    rating: 4.7,
    image: "A",
  },
...
const topics = [
  {
    ...
    desc: "Find clarity in matters of the heart.",
  },
  {
    icon: Briefcase,
  ...
  },
  {
    ...
    desc: "Guidance for family life.",
  },
  {
    icon: Activity,
    title: "Health & Wellness",
    desc: "Understand your well-being.",
  },
  {
    icon: Home,
    ...
    <>
      <PageHero
        ...
        title={
          <>
            Connect with{" "}
            <span className="gradient-text">Expert Astrologers</span>
          </>
        }
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Book a consultation today and get the clarity you need to move
              forward.
            </p>

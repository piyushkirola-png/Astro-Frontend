...
// Bhagyank meanings
const bhagyankMeanings: {
  [key: number]: { title: string; description: string };
} = {
  1: {
    title: "The Pioneer",
    description:
      "You are meant to lead, innovate, and create new paths. Your destiny is to be independent and self-reliant.",
  },
  2: {
    title: "The Diplomat",
    description:
      "Your destiny involves cooperation, partnerships, and bringing people together. You are a natural peacemaker.",
  },
  3: {
    title: "The Creator",
    description:
  ...
  4: {
    title: "The Builder",
    description:
      "Your destiny is to build solid foundations, create systems, and bring stability to your community.",
  },
  5: {
  ...
  6: {
    title: "The Nurturer",
    description:
      "Your destiny involves caring for others, creating harmony, and being responsible for family and community.",
  },
  7: {
    title: "The Seeker",
    description:
  ...
  8: {
    title: "The Achiever",
    description:
      "Your destiny is to achieve success, build wealth, and reach positions of power and authority.",
  },
  9: {
...
export default function MulankCalculator() {
  ...
  const calculateMulank = (day: string, month: string, year: string) => {
    ...
    if (mulank === bhagyank) {
      compatibility =
        "Perfect Alignment - Your nature and destiny are in complete harmony!";
    } else if (
      mulank === 1 &&
      (bhagyank === 3 || bhagyank === 5 || bhagyank === 6)
    ) {
      compatibility =
        "Good Alignment - Your leadership qualities complement your destiny.";
    } else if (
      mulank === 2 &&
      (bhagyank === 4 || bhagyank === 6 || bhagyank === 7)
    ) {
      compatibility =
        "Good Alignment - Your diplomatic nature supports your life path.";
    } else if (
      mulank === 3 &&
      (bhagyank === 1 || bhagyank === 5 || bhagyank === 6)
    ) {
      compatibility =
        "Good Alignment - Your creativity aligns well with your destiny.";
    } else if (mulank === 4 && bhagyank === 5) {
      compatibility =
        "Balanced Alignment - Your practicality supports your adventurous destiny.";
    } else if (
      mulank === 5 &&
      (bhagyank === 1 || bhagyank === 3 || bhagyank === 6)
    ) {
      compatibility =
        "Good Alignment - Your adaptability serves your life purpose.";
    } else if (
      mulank === 6 &&
      (bhagyank === 3 || bhagyank === 5 || bhagyank === 9)
    ) {
      compatibility =
        "Good Alignment - Your caring nature aligns with your destiny.";
    } else if (
      mulank === 7 &&
      (bhagyank === 2 || bhagyank === 4 || bhagyank === 6)
    ) {
      compatibility = "Good Alignment - Your wisdom supports your life path.";
    } else if (mulank === 8 && bhagyank === 5) {
      compatibility =
        "Balanced Alignment - Your ambition aligns with your destiny.";
    } else if (
      mulank === 9 &&
      (bhagyank === 1 || bhagyank === 3 || bhagyank === 6)
    ) {
      ...
      compatibility =
        "You may need to consciously align your actions with your destiny. Your nature and life path complement each other with effort.";
    }
        ...
        <Reveal delay={0.3}>
          <div className="max-w-3xl mx-auto">
            <p className="text-base text-ink-600 leading-relaxed">
              ...
              is a simple tool that finds your personal life number using your
              birth date. This number comes from ancient numerology and helps
              explain your nature, career path, and how you connect with people.
              Your Mulank number is like a personal helper it shows your
              strengths and areas where you may face challenges.
            </p>
          </div>
        </Reveal>
      </div>
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-ink-500">
                    Find your Mulank and Bhagyank numbers
                  </p>
                </div>
              </div>
              ...
              {result && (
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div
                      className={`bg-gradient-to-br ${result.mulankMeaning.color} rounded-xl p-4 text-white text-center`}
                    >
                      ...
                      <div className="text-sm mt-1">
                        {result.mulankMeaning.title}
                      </div>
                      <div className="text-2xl mt-1">
                        {result.mulankMeaning.emoji}
                      </div>
                    </div>
          ...
          <Reveal delay={0.1}>
            <div className="bg-white rounded-2xl p-8 border border-ink-100 w-full">
              <p className="text-ink-700 leading-relaxed">
                Mulank is your special number that comes from your birth date.
                In fact, your Birth Number and Ruling Number are also extracted
                from your date of birth, offering deeper personality insights.
                In Hindi numerology,{" "}
                <span className="font-semibold text-primary-600">"Mul"</span>
                means root or base, and{" "}
                <span className="font-semibold text-primary-600">
                  "Ank"
                </span>{" "}
                means number. So, Mulank is your foundation number, like the
                starting point of your personality and life energy.
              </p>
              <div className="mt-4 p-4 bg-accent-50 rounded-xl border border-accent-200">
                <p className="text-sm text-ink-700">
                  <span className="font-semibold">ðŸ’¡ This number</span> tells
                  a lot about how you think, feel, and act. It's like a simple
                  guidebook that helps explain your natural habits and the way
                  you handle life's ups and downs. Your Mulank plays a big role
                  in how you deal with relationships, how well you do in your
                  career, and the direction your life usually takes.
                </p>
              </div>
              <div className="mt-4 p-4 bg-primary-50 rounded-xl border border-primary-200">
                <p className="text-sm text-ink-700">
                  <span className="font-semibold">âœ¨ The best part?</span>{" "}
                  Mulank is easy to calculate. You don't need any complicated
                  math or fancy tools. Once you know your Mulank number, you can
                  start using it right away to make smarter everyday choices and
                  plan your future more confidently.
                </p>
              </div>
            </div>
          </Reveal>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  ...
                  <span>
                    ...
                    <span className="font-semibold">birth date only</span> (day)
                  </span>
                </li>
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  <CheckCircle className="h-4 w-4 text-primary-500 shrink-0 mt-0.5" />
                  <span>
                    Shows your{" "}
                    <span className="font-semibold">natural personality</span>{" "}
                    and how you think
                  </span>
                </li>
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  <CheckCircle className="h-4 w-4 text-primary-500 shrink-0 mt-0.5" />
                  <span>
                    Your <span className="font-semibold">true self</span> that
                ...
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  <CheckCircle className="h-4 w-4 text-primary-500 shrink-0 mt-0.5" />
                  <span>
                    Shapes your habits, likes, dislikes, and reactions
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100 hover:shadow-lg transition-all">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  ...
                  <span>
                    Calculated from your{" "}
                    <span className="font-semibold">full birth date</span> (day
                    + month + year)
                  </span>
                </li>
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  ...
                  <span>
                    Shows your{" "}
                    <span className="font-semibold">life path or destiny</span>
                  </span>
                </li>
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  <CheckCircle className="h-4 w-4 text-accent-500 shrink-0 mt-0.5" />
                  <span>
                    ...
                    <span className="font-semibold">meant to do</span>
                  </span>
                </li>
                <li className="flex items-start gap-2 text-sm text-ink-600">
                  <CheckCircle className="h-4 w-4 text-accent-500 shrink-0 mt-0.5" />
                  <span>
                    Gives a <span className="font-semibold">bigger view</span>{" "}
        ...
        <Reveal delay={0.3}>
          <div className="mt-6 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-accent-50 to-primary-50 rounded-2xl p-6 border border-accent-200">
              ...
              <p className="text-sm text-ink-600">
                Meera from Bhopal had Mulank 6 (caring, wants peace) and
                Bhagyank 8 (success in business). When she understood both
                numbers, she found a way to manage her family life while also
          ...
          <Reveal delay={0.1}>
            <div className="bg-white rounded-2xl p-8 border border-ink-100 w-full">
              <p className="text-ink-700 leading-relaxed mb-6">
                All you need is your birth date, and the whole process takes
                just a few minutes. This method has been used for centuries and
                is still trusted because it's that accurate and reliable.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-ink-50 rounded-xl p-6">
                  ...
                  <div className="space-y-2 text-sm text-ink-600">
                    <p>
                      <span className="font-semibold">Birth Date:</span> 15th
                      March 1990
                    </p>
                    <p>
                      <span className="font-semibold">Take the day:</span> 15
                    </p>
                    <p>
                      <span className="font-semibold">Add digits:</span> 1 + 5 ={" "}
                ...
                <div className="bg-ink-50 rounded-xl p-6">
                  ...
                  <div className="space-y-2 text-sm text-ink-600">
                    <p>
                      <span className="font-semibold">Birth Date:</span> 29th
                      January 1985
                    </p>
                    <p>
                      <span className="font-semibold">Take the day:</span> 29
                    </p>
                    <p>
                      <span className="font-semibold">Add digits:</span> 2 + 9 =
                      11
                    </p>
                    <p>
                      <span className="font-semibold">Add again:</span> 1 + 1 ={" "}
                      <span className="font-bold text-primary-600 text-lg">
                        2
                      </span>
                    </p>
              ...
              <div className="mt-6 p-4 bg-accent-50 rounded-xl border border-accent-200">
                <p className="text-sm text-ink-700">
                  <span className="font-semibold">ðŸ’¡ Pro Tip:</span> If the
                  total is a two-digit number, just add those two digits again
                  until you get a single number (1-9).
                </p>
              </div>
            </div>
          </Reveal>
        ...
        <div className="mt-8 w-full">
          <Reveal delay={0.1}>
            <div className="bg-ink-50 rounded-2xl p-8 border border-ink-100 w-full">
              <p className="text-ink-700 leading-relaxed">
                A Mulank calculator is an easy online tool that finds your life
                number using your date of birth. It follows the traditional
                numerology method, but you don't have to do any hard math by
                yourself. These tools also often tell you more about what your
                number means and how it can guide your life.
              </p>
...
function HowToUse() {
  const steps = [
    ...
    },
    {
      ...
      description:
        'Click "Calculate Mulank" to get your Mulank and Bhagyank numbers.',
    },
  ];
            ...
            <Reveal key={num} delay={i * 0.05}>
              <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100 hover:border-accent-200 hover:shadow-lg transition-all">
                <div className="flex items-center gap-3 mb-3">
                  <div
                    className={`w-10 h-10 rounded-full bg-gradient-to-br ${meaning.color} flex items-center justify-center text-white font-bold text-lg`}
                  >
                    {num}
                  </div>
                ...
                <p className="text-sm text-ink-500 mt-3 leading-relaxed">
                  {meaning.traits.join(", ")}. Great for careers in{" "}
                  {meaning.careers.slice(0, 2).join(", ")}.
                </p>
              </div>
            </Reveal>
          ))}
  ...
  const benefits = [
    {
      ...
      description:
        "Your mulank can tell you which career suits your natural strengths. Many people struggle at jobs that don't match their number's energy.",
    },
    {
      icon: Heart,
      title: "Relationship Understanding",
      description:
        "Your mulank shows how you connect with others. Different numbers talk and feel differently, helping make relationships smoother.",
    },
    {
      icon: Compass,
      title: "Decision Making",
      description:
        "When you have to make big choices, your mulank can guide you to pick what suits your nature for better results.",
    },
    {
      icon: TrendingUp,
      title: "Personal Growth",
      description:
        "Knowing your mulank helps you see your strengths and areas you need to work on, helping you grow faster.",
    },
    {
      icon: Calendar,
      title: "Timing Decisions",
      description:
        "Some days and months work better for certain mulank numbers. Starting something important on these dates brings more success.",
    },
    {
      icon: Activity,
      title: "Health and Wellness",
      description:
        "Your mulank affects how your body and mind behave. Match your lifestyle with your mulank energy for better health.",
    },
  ];
      ...
      <div className="container-8xl">
        ...
        <div className="mt-8 w-full">
          <Reveal delay={0.1}>
            <div className="bg-ink-50 rounded-2xl p-8 border border-ink-100 w-full">
              <p className="text-ink-700 leading-relaxed">
                Astrologers often mix Mulank readings with other tools like
                astrology and tarot. This gives a full picture of your life your
                strengths, struggles, and best direction forward. It also helps
                you take better steps in your career, love life, or personal
                journey.
              </p>
              <div className="mt-4 grid md:grid-cols-3 gap-4">
                <div className="bg-white rounded-xl p-4 border border-ink-100 text-center">
                  ...
                  <p className="text-xs text-ink-500">
                    Combined with birth chart for deeper insights
                  </p>
                </div>
                <div className="bg-white rounded-xl p-4 border border-ink-100 text-center">
                  ...
                  <p className="text-xs text-ink-500">
                    Used alongside for complete guidance
                  </p>
                </div>
                <div className="bg-white rounded-xl p-4 border border-ink-100 text-center">
                  ...
                  <p className="text-xs text-ink-500">
                    Combined with Life Path Number and Name Numerology
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="relative container-8xl text-center">
        ...
        <Reveal delay={0.1}>
          <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            ...
            <span className="gradient-text-light">Mulank number?</span>
          </h2>
        </Reveal>

        <Reveal delay={0.2}>
          <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
            Calculate your Mulank and Bhagyank numbers now and unlock the
            secrets of your birth date.
          </p>
        </Reveal>

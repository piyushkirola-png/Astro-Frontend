...
// Zodiac signs data
const zodiacSigns = [
    { name: 'Aries', date: 'Mar 21 - Apr 19', emoji: 'â™ˆ', color: 'from-red-500 to-orange-500' },
    { name: 'Taurus', date: 'Apr 20 - May 20', emoji: 'â™‰', color: 'from-green-500 to-emerald-500' },
    { name: 'Gemini', date: 'May 21 - Jun 21', emoji: 'â™Š', color: 'from-yellow-500 to-amber-500' },
    { name: 'Cancer', date: 'Jun 22 - Jul 22', emoji: 'â™‹', color: 'from-blue-400 to-cyan-500' },
    { name: 'Leo', date: 'Jul 23 - Aug 22', emoji: 'â™Œ', color: 'from-orange-500 to-yellow-500' },
    { name: 'Virgo', date: 'Aug 23 - Sep 22', emoji: 'â™', color: 'from-green-600 to-lime-500' },
    { name: 'Libra', date: 'Sep 23 - Oct 23', emoji: 'â™Ž', color: 'from-pink-500 to-rose-500' },
    { name: 'Scorpio', date: 'Oct 24 - Nov 21', emoji: 'â™', color: 'from-red-600 to-purple-700' },
    { name: 'Sagittarius', date: 'Nov 22 - Dec 21', emoji: 'â™', color: 'from-purple-500 to-indigo-500' },
    { name: 'Capricorn', date: 'Dec 22 - Jan 19', emoji: 'â™‘', color: 'from-gray-600 to-slate-700' },
    { name: 'Aquarius', date: 'Jan 20 - Feb 18', emoji: 'â™’', color: 'from-cyan-500 to-blue-500' },
    { name: 'Pisces', date: 'Feb 19 - Mar 20', emoji: 'â™“', color: 'from-purple-400 to-pink-400' },
];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (selectedSign && partnerSign) {
            ...
            setMatchResult({
                ...
                advice: 'Focus on open communication and mutual respect. Celebrate your differences and grow together.',
            });
        }
    };
                ...
                <Reveal delay={0.3}>
                    <div className="max-w-3xl mx-auto">
                        <p className="text-base text-ink-600 leading-relaxed">
                            Zodiac sign compatibility reveals more than just compatibility in romantic relationships. 
                            You can also find information on your partner's and your own zodiac love and sexual 
                            compatibility. This can ensure a long-lasting relationship with shared understanding 
                            while assisting you in learning further about your mate and your bond.
                        </p>
                    </div>
                </Reveal>
            </div>
                    ...
                    <Reveal>
                        <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-ink-900">Check Your Compatibility</h2>
                                    <p className="text-xs text-ink-500">Select your zodiac signs to find your match</p>
                                </div>
                            </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-ink-700 mb-2">
                                            Your Zodiac Sign <span className="text-danger-500">*</span>
                                        </label>
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-ink-700 mb-2">
                                            Partner's Zodiac Sign <span className="text-danger-500">*</span>
                                        </label>
                                        <div className="relative">
                                ...
                                >
                                    <div className="text-center mb-4">
                                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent-50 rounded-full">
                                            ...
                                            <span className="text-sm font-semibold text-ink-900">Compatibility Score</span>
                                        </div>
                                        <div className="mt-3 text-5xl font-bold gradient-text">
                                            {matchResult.score}%
                                        </div>
                                        <p className="text-sm text-ink-600 mt-2">{matchResult.message}</p>
                                    </div>
                    ...
                    <Reveal delay={0.1}>
                        <div className="bg-ink-50 rounded-2xl p-8 border border-ink-100 w-full">
                            <p className="text-ink-700 leading-relaxed">
                                You don't always get along like a blaze on flames with people, but when you're with 
                                that "special person," you feel happy and in control of the situation. We encounter 
                                numerous people throughout life. One person would be your life partner out of all 
                                those who may be terrific friends or mentors for you. You must make the appropriate 
                                choice for that person. They must make you feel at home, never depressed or too uncared for.
                            </p>
                            <div className="mt-4 p-4 bg-accent-50 rounded-xl border border-accent-200">
                                <p className="text-sm text-ink-700">
                                    <span className="font-semibold">ðŸ’¡ Did you know?</span> Love compatibility can also 
                                    forecast how your relationship will develop in the future, in addition to letting 
                                    you know how things stand right now. It reveals the strength of your current bond, 
                                    what makes it successful, and if you and your loved one are about to experience 
                                    harmony or conflict in the future.
                                </p>
                            </div>
                        </div>
                    </Reveal>
    ...
    const reasons = [
        {
            ...
            description: 'Understand the emotional bond you share with your partner and how your signs interact on a deeper level.',
            color: 'from-pink-500 to-rose-500'
        },
        {
            icon: TrendingUp,
            title: 'Future Predictions',
            description: 'Get insights into how your relationship will evolve and what challenges or harmony lies ahead.',
            color: 'from-blue-500 to-cyan-500'
        },
        {
            icon: Users,
            title: 'Better Understanding',
            description: 'Learn more about your partner\'s personality traits, needs, and expectations in the relationship.',
            color: 'from-green-500 to-emerald-500'
        },
        {
            icon: Zap,
            title: 'Harmony & Conflict',
            description: 'Identify potential areas of conflict and discover how to maintain harmony in your relationship.',
    ...
    const tips = [
        {
            ...
            description: 'Understand the core traits of both zodiac signs to appreciate each other\'s strengths.'
        },
        {
            icon: Heart,
            title: 'Embrace Differences',
            description: 'Your differences can be your greatest strength. Learn to complement each other.'
        },
        {
            icon: Shield,
            title: 'Build Trust',
            description: 'Trust is the foundation of any relationship. Work on building and maintaining it.'
        },
        {
            icon: Award,
            title: 'Grow Together',
            description: 'Use your compatibility insights to grow together as a couple.'
        }
    ];
                    ...
                    {tips.map((tip, i) => (
                        <Reveal key={tip.title} delay={i * 0.1}>
                            <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100 hover:border-accent-200 hover:shadow-lg transition-all text-center">
                                ...
                                <p className="text-sm text-ink-500 leading-relaxed">{tip.description}</p>
                            </div>
                        </Reveal>
                    ))}
                </div>
            ...
            <div className="relative container-8xl text-center">
                ...
                <Reveal delay={0.1}>
                    <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
                        Ready to discover your <span className="gradient-text-light">cosmic connection?</span>
                    </h2>
                </Reveal>

                <Reveal delay={0.2}>
                    <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
                        Check your zodiac sign compatibility and find out if you and your partner are a perfect match.
                    </p>
                </Reveal>

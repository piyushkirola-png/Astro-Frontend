...
const testimonials = [
  { name: 'Priya Sharma', quote: 'The free kundali generator gave me amazing insights about my life path. Highly recommended!', rating: 5 },
  { name: 'Rahul Verma', quote: 'The love calculator was so accurate! It perfectly described my relationship compatibility.', rating: 5 },
  { name: 'Ananya Patel', quote: 'I use the panchang daily for planning important events. It\'s been incredibly helpful.', rating: 4 },
];
...
export default function FreeServices() {
  return (
    <>
      <PageHero
        badge="Free Services"
        title={<>Explore Free <span className="gradient-text">Astrology Tools</span></>}
            ...
            {freeServices.map((service, i) => (
              <Reveal key={service.title} delay={(i % 3) * 0.08}>
                <div className="group h-full bg-ink-50 rounded-2xl p-7 border border-ink-100 hover:border-accent-300 hover:bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${service.color} w-fit mb-5 group-hover:scale-110 group-hover:rotate-3 transition-transform`}>
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Explore all our free astrology tools and start your journey of self-discovery today.
            </p>

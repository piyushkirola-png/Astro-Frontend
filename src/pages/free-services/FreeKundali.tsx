                ...
                <Reveal delay={0.3}>
                    <div className="max-w-3xl mx-auto">
                        <p className="text-base text-ink-600 leading-relaxed">
                            <span className="font-semibold text-primary-600">Jyotish AI's</span> free online kundli tool
                            will help you generate a detailed Janam Kundli instantly. Based on the principles of
                            Vedic Astrology, this tool provides accurate details of the Globeary positions, houses,
                            doshas, dashas, nakshatras, etc., in your birth chart. Our team of expert astrologers
                            has tested it rigorously to deliver the best results. If you are curious about your future
                            or want to work through past traumas, this free kundali online tool is the right choice for you.
                        </p>
                    </div>
                </Reveal>
            </div>
                        ...
                        <Reveal>
                            <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                                <div className="flex items-center gap-3 mb-5">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-bold text-ink-900">New Kundli</h2>
                                        <p className="text-xs text-ink-500">Enter your birth details below</p>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                className={`py-2.5 px-4 rounded-xl border-2 font-medium transition-all text-sm ${formData.gender === 'male'
                                            ...
                                            <button
                                                ...
                                                className={`py-2.5 px-4 rounded-xl border-2 font-medium transition-all text-sm ${formData.gender === 'female'
                                                        ? 'border-primary-500 bg-primary-50 text-primary-700'
                                                        : 'border-ink-200 bg-white text-ink-600 hover:border-ink-300'
                                                    }`}
                                            >
                    ...
                    <div className="lg:col-span-1">
                        <Reveal delay={0.2}>
                            <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-6 border border-primary-100 h-full flex flex-col items-center justify-center text-center">
                                ...
                                <h3 className="text-lg font-bold text-ink-900 mb-1">Saved Kundli</h3>
...
function WhatIsKundli() {
    const houses = [
        ...
        { number: 5, name: 'Trikona or Putra Bhava', title: 'Creativity and Children' },
        ...
        { number: 12, name: 'Vyaya Bhava', title: 'Spirituality and Foreign Connections' },
    ];
                    ...
                    <Reveal delay={0.1}>
                        <div className="bg-white rounded-2xl p-8 border border-ink-100 mb-8 w-full">
                            <p className="text-ink-700 leading-relaxed">
                                A Kundli is much more than just a chart. It is the precise position of all the Globes
                                and nakshatras in your horoscope at the exact time of your birth. You can check the
                                astrological positions of the Sun, Moon, Rahu, Ketu, Saturn, Jupiter, Mars, Mercury,
                                and Venus across the 12 houses and 12 zodiac signs. It helps you decode your personality
                                and your past, present, and future, as well as prominent life events.
                            </p>
                            <div className="mt-4 p-4 bg-accent-50 rounded-xl border border-accent-200">
                                <p className="text-sm text-ink-700">
                                    <span className="font-semibold">âœ¨ Note:</span> Two people born on the same day may
                                    have different Janam Kundlis because even a few seconds' difference can shift the
                                    Lagna and other Globeary placements. This is why exact birth details matter while
                                    generating your Kundali online.
                                </p>
                            </div>
                        </div>
                    </Reveal>
                            ...
                            {houses.map((house, i) => (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-ink-900 text-sm">{house.name}</h4>
...
function KeyElements() {
    const Globes = [
        { name: 'Sun', description: 'authority, confidence, father figures, leadership', icon: Sun },
        { name: 'Moon', description: 'emotions, mental peace, feminine energy, intuition', icon: Moon },
        { name: 'Mars', description: 'aggression, courage, discipline, action', icon: Globe },
        { name: 'Mercury', description: 'communication, intelligence, logic, business', icon: Globe },
        { name: 'Jupiter', description: 'wisdom, spirituality, wealth, teacher, expansion', icon: Globe },
        { name: 'Venus', description: 'luxury, beauty, desires, relationship, romance', icon: Globe },
        { name: 'Saturn', description: 'karma, delays, patience, responsibility', icon: Globe },
        { name: 'Rahu', description: 'ambition, obsession, foreign influence, unconventional success', icon: Globe },
        { name: 'Ketu', description: 'spirituality, detachment, past-life karmas, intuition', icon: Globe },
    ];
        ...
        <section className="py-16 bg-white">
            <div className="container-8xl">
                ...
                <div className="mt-8 grid gap-6 max-w-6xl mx-auto">
                    ...
                    <Reveal delay={0.1}>
                        <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                            <h3 className="text-xl font-bold text-ink-900 mb-2">Lagna/Ascendant - The Foundation Of Your Chart</h3>
                            <p className="text-ink-600 leading-relaxed">
                                Vedic astrologers consider Lagna more important than your Sun sign. Lagna is like the
                                starting point of your life and represents the zodiac sign rising on the eastern horizon
                                at the time of your birth. For example, Mars can be beneficial for an Aries Lagna but
                                bring challenges for the Libra Lagna.
                            </p>
                        </div>
                    </Reveal>
                    ...
                    <Reveal delay={0.2}>
                        <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                            <h3 className="text-xl font-bold text-ink-900 mb-4">Navgrahas - The 9 Globes and Their Role</h3>
                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                {Globes.map((Globe) => (
                                    <div key={Globe.name} className="bg-white rounded-xl p-4 border border-ink-100">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Globe.icon className="h-4 w-4 text-primary-500" />
                                            <span className="font-semibold text-ink-900">{Globe.name}</span>
                                        </div>
                            ...
                            <div className="mt-4 p-3 bg-accent-50 rounded-xl border border-accent-200">
                                <p className="text-sm text-ink-700">
                                    <span className="font-semibold">ðŸ’¡ FYI:</span> No Globe gives permanently negative
                                    results. Even Saturn and Rahu bestow success to a person when placed correctly in a chart.
                                </p>
                            </div>
                        </div>
                    </Reveal>
                    ...
                    <Reveal delay={0.3}>
                        <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                            <h3 className="text-xl font-bold text-ink-900 mb-2">Nakshatras - Your Birth Star</h3>
                            <p className="text-ink-600 leading-relaxed">
                                The lunar constellation that the Moon occupies at your birth is called your Nakshatra.
                                While the zodiac sign reveals your personality traits, Nakshatra is responsible for your
                                compatibility, emotional patterns, instincts, and karmic tendencies on a deeper level.
                            </p>
                            <div className="mt-3 grid sm:grid-cols-2 gap-3">
                                <div className="bg-white rounded-xl p-3 border border-ink-100">
                                    <span className="font-semibold text-ink-900">Ashwini Nakshatra</span>
                                    <p className="text-xs text-ink-500">Quick and independent</p>
                                </div>
                                <div className="bg-white rounded-xl p-3 border border-ink-100">
                                    <span className="font-semibold text-ink-900">Rohini Nakshatra</span>
                                    <p className="text-xs text-ink-500">Creative and emotionally expressive</p>
                                </div>
                            </div>
                        </div>
                    </Reveal>
                    ...
                    <Reveal delay={0.4}>
                        <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                            <h3 className="text-xl font-bold text-ink-900 mb-2">Dasha System - Your Life Timeline</h3>
                            <p className="text-ink-600 leading-relaxed">
                                According to Vimshottari Dasha, a human life is divided into Globeary periods totalling
                                120 years. Each mahadasha activates the theme of a particular Globe. Like, Jupiter
                                Mahadasha results in marriage, childbirth, education, and wisdom, while Saturn Mahadasha
                                brings more responsibility, career pressure, and long-term growth for a native.
                            </p>
                        </div>
                    </Reveal>
                </div>
...
function DoshasSection() {
    const doshas = [
        {
            name: 'Mangal Dosha',
            description: 'When Mars occupies a certain house of a birth chart, Mangal Dosha is formed. However, not everyone under the effect of Mars experiences marital issues.',
            remedy: 'People with a strong kundali and a balanced Jupiter and Venus can reduce the Mangal Dosha\'s impact significantly.',
        },
        {
            name: 'Kaal Sarp Dosha',
            description: 'This dosha is formed when all the 7 Globes in a Janam Kundali fall between Rahu and Ketu. It forms a snake-like grip on life.',
            remedy: 'The intensity of the effects depends on the house placement, Globeary strengths, and other dashas.',
        },
        {
            name: 'Pitra Dosha',
            description: 'This Dosha is linked to unresolved ancestral Karma and is associated with the Sun, Rahu, and the 9th house.',
            remedy: 'Performing charity work and ancestral rituals after consulting an expert astrologer can help pacify this dosha.',
        },
        {
            name: 'Shani Dosha / Sade Sati',
            description: 'Sade Sati is a period of 7.5 years of Saturn\'s transit around the natal moon. It teaches discipline, maturity, and long-term restructuring.',
            remedy: 'People who lead a disciplined life and work hard are rewarded with lasting success during Sade Sati.',
        },
    ];
                    ...
                    {doshas.map((dosha, i) => (
                        <Reveal key={dosha.name} delay={i * 0.1}>
                            <div className="bg-white rounded-2xl p-6 border border-ink-100 hover:border-accent-200 hover:shadow-lg transition-all">
                                <h3 className="text-lg font-bold text-ink-900 mb-2">{dosha.name}</h3>
                                <p className="text-sm text-ink-600 leading-relaxed mb-3">{dosha.description}</p>
                                <div className="p-3 bg-accent-50 rounded-xl border border-accent-200">
                                    <p className="text-sm text-ink-700">
                                        <span className="font-semibold">ðŸ”® Remedy:</span> {dosha.remedy}
                                    </p>
                                </div>
                            </div>
                        </Reveal>
        ...
        <section className="py-16 bg-white">
            <div className="container-8xl">
                ...
                <div className="mt-8 grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                    <Reveal delay={0.1}>
                        <div className="bg-ink-50 rounded-2xl p-6 border border-ink-100">
                            <h3 className="text-lg font-bold text-ink-900 mb-3">Ashtakoot System</h3>
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="h-5 w-5 text-success-500 shrink-0 mt-0.5" />
                                    <div>
                                        <span className="font-semibold text-ink-900">18+ points</span>
                                        <p className="text-sm text-ink-500">Considered decent compatibility</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="h-5 w-5 text-success-500 shrink-0 mt-0.5" />
                                    <div>
                                        <span className="font-semibold text-ink-900">24+ points</span>
                                        <p className="text-sm text-ink-500">Indicate good compatibility</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="h-5 w-5 text-success-500 shrink-0 mt-0.5" />
                                    <div>
                                        <span className="font-semibold text-ink-900">30+ points</span>
                                        <p className="text-sm text-ink-500">Viewed as a very strong match</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <Reveal delay={0.2}>
                        <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-6 border border-primary-100">
                            <h3 className="text-lg font-bold text-ink-900 mb-3">Expert Analysis</h3>
                            <p className="text-ink-600 leading-relaxed mb-3">
                                Expert astrologers don't rely on score totals alone. They also analyse:
                            </p>
    ...
    const features = [
        {
            ...
            description: 'Based on precise Vedic astrology principles and thoroughly tested by expert astrologers.'
        },
        {
            icon: Sparkles,
            title: 'Simple Language',
            description: 'Detailed insights explained in easy-to-understand language, not technical jargon.'
        },
        {
            icon: Users,
            title: 'Expert Guidance',
            description: 'Option to talk to expert Vedic Astrologers on call or chat for personalized guidance.'
        },
        {
            icon: Heart,
            title: 'Comprehensive Analysis',
            description: 'Beyond basic PDFs - get detailed Globeary positions, houses, doshas, and dashas analysis.'
        }
    ];
            ...
            <div className="container-8xl">
                ...
                <Reveal delay={0.4}>
                    <div className="mt-8 bg-white rounded-2xl p-6 border border-ink-100 max-w-6xl mx-auto">
                        <h3 className="text-lg font-bold text-ink-900 mb-3">How To Get the Most Accurate Kundli?</h3>
                        <p className="text-ink-600 leading-relaxed mb-4">
                            The most important element to get an accurate online kundli is your date of birth.
                            Even a few-second difference can make a big change to your predictions as it shifts
                            your ascendant, dasha calculations, and house placements.
                        </p>
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="bg-ink-50 rounded-xl p-4">
                                <h4 className="font-semibold text-ink-900 text-sm mb-2">Check your birth time from:</h4>
                            ...
                            <div className="bg-ink-50 rounded-xl p-4">
                                <h4 className="font-semibold text-ink-900 text-sm mb-2">Divisional charts for accuracy:</h4>
                                <ul className="space-y-1 text-sm text-ink-500">
            ...
            <div className="relative container-8xl text-center">
                ...
                <Reveal delay={0.1}>
                    <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
                        Ready to discover your <span className="gradient-text-light">cosmic blueprint?</span>
                    </h2>
                </Reveal>

                <Reveal delay={0.2}>
                    <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
                        Generate your free Kundli now and unlock the secrets of your birth chart
                        for a brighter, more fulfilling life.
                    </p>
                </Reveal>

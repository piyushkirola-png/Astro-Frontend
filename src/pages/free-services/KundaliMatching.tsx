        ...
        <Reveal delay={0.3}>
          <div className="max-w-3xl mx-auto">
            <p className="text-base text-ink-600 leading-relaxed">
              ...
              free online Kundali Matching tool to find your marriage
              compatibility instantly. Based on Vedic Astrology principles, our
              Kundli Milan system assesses compatibility between two people
              using the Ashtakoota method, Guna Milan Score out of 36 Gunas,
              Mangal Dosha analysis, and detailed horoscope-matching factors.
              Whether it's a love marriage or an arranged marriage, online
              kundli matching is important for understanding emotional
              compatibility, family growth, long-term stability, and
              relationship harmony before marriage.
            </p>
          </div>
        </Reveal>
      </div>
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-ink-500">
                    Enter birth details of both partners
                  </p>
                </div>
              </div>
                          ...
                          {["Male", "Female", "Other"].map((gender) => (
                            <button
                              ...
                              className={`py-2 px-3 rounded-xl border-2 font-medium transition-all text-sm ${
                                formData.yourGender === gender.toLowerCase()
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {["Male", "Female", "Other"].map((gender) => (
                            <button
                              ...
                              className={`py-2 px-3 rounded-xl border-2 font-medium transition-all text-sm ${
                                formData.partnerGender === gender.toLowerCase()
                                  ? "border-primary-500 bg-primary-50 text-primary-700"
                                  : "border-ink-200 bg-white text-ink-600 hover:border-ink-300"
                              }`}
                            >
          ...
          <Reveal delay={0.1}>
            <div className="bg-white rounded-2xl p-8 border border-ink-100 w-full">
              <p className="text-ink-700 leading-relaxed">
                Kundli matching, also known as Horoscope Matching is a
                traditional Vedic Astrology method that astrologers use to check
                compatibility between two people before marriage. In Hindu
                Astrology, the Janam Kundlis of both partners are evaluated and
                compared to determine whether they are emotionally, physically,
                and mentally aligned for a long-term marriage.
              </p>
              <div className="mt-4 p-4 bg-accent-50 rounded-xl border border-accent-200">
                <p className="text-sm text-ink-700">
                  <span className="font-semibold">ðŸ’¡ Note:</span> The process
                  involves matching planetary positions, Nakshatras, Moon signs,
                  and the Ashtakoota Guna Milan system out of 36 points.
                </p>
              </div>
              <div className="mt-4 p-4 bg-primary-50 rounded-xl border border-primary-200">
                <p className="text-sm text-ink-700">
                  <span className="font-semibold">âœ¨ In Vedic Astrology,</span>{" "}
                  marriage is more than just a social bond; it is a karmic
                  union. This is why checking compatibility goes beyond
                  attraction and focuses on areas like finances, children,
                  health, emotional, and spiritual alignment.
                </p>
              </div>
            </div>
          </Reveal>
  ...
  const reasons = [
    {
      ...
      description:
        "Understand emotional and mental compatibility before marriage. The Gana and Graha Maitri kootas help assess whether both partners meet each other's emotional expectations.",
    ...
    },
    {
      ...
      description:
        "Strong alignment in Graha Maitri and Bhakakoot often leads to mutual financial growth, shared goals, and better financial decision-making as a couple.",
    ...
    },
    {
      ...
      description:
        "Nadi Matching plays an important role in physical compatibility, overall well-being of family life, and hereditary patterns.",
    ...
    },
    {
      ...
      description:
        "Analyse family happiness, children-related issues, and long-term domestic stability through the 5th house, nadi compatibility, and Jupiter's placement.",
      ...
      <div className="container-8xl">
        ...
        <Reveal delay={0.4}>
          <div className="mt-8 bg-gradient-to-br from-accent-50 to-primary-50 rounded-2xl p-6 border border-accent-200 max-w-6xl mx-auto">
            <h3 className="text-lg font-bold text-ink-900 mb-2">
              Does Kundali Matching Work for Love Marriages?
            </h3>
            <p className="text-ink-600 leading-relaxed">
              Yes, Kundli Matching is just as important for love marriages. In
              fact, many couples seek astrological guidance through Kundli Milan
              even after becoming emotionally committed. Sometimes, couples feel
              deeply emotionally invested before marriage, but their
              incompatible dasha, mangalik imbalance, unfavourable planetary
              placements, or conflicting temperament may create post-marital
              issues. Kundli Matching helps identify and rectify these patterns
              early.
            </p>
          </div>
        </Reveal>
...
function HowMatchingWorks() {
  const steps = [
    {
      number: 1,
      title: "Generate Janam Kundli",
      description:
        "Create accurate birth charts for both individuals using their dates, times, and places of birth.",
    },
    {
      number: 2,
      title: "Ashtakoota Guna Milan",
      description:
        "Compare both charts using 8 compatibility factors and assign points out of 36 gunas.",
    },
    {
      number: 3,
      title: "Check Mangal Dosha",
      description:
        "Analyze Mars placement to identify aggression, conflicts, or delays in marriage.",
    },
    {
      number: 4,
      title: "7th House Compatibility",
      description:
        "Compare the 7th house in both charts with ruling planets Venus and Jupiter.",
    },
    {
      number: 5,
      title: "Examine Dasha Periods",
      description:
        "Consider Mahadasha and Antardasha periods before finalising a marriage report.",
    },
    {
      number: 6,
      title: "Navamsa Chart Analysis",
      description:
        "Analyze D9 chart to reveal deeper strengths and weaknesses of the relationship.",
    },
  ];
  ...
  const kootas = [
    {
      name: "Verna Koota",
      points: 1,
      meaning: "Spiritual compatibility and ego alignment",
    },
    {
      name: "Vashya Koota",
      points: 2,
      meaning: "Mutual attraction and balance of control",
    },
    ...
    },
    {
      name: "Graha Maitri",
      points: 5,
      meaning: "Mental, emotional, and intellectual compatibility",
    },
    {
      name: "Gana Koota",
      points: 6,
      meaning: "Compatibility of temperament and inherent nature",
    },
    {
      name: "Bhakoot Koota",
      points: 7,
      meaning: "Financial harmony and love balance",
    },
    {
      name: "Nadi Koota",
      points: 8,
      meaning: "Health and genetic compatibility, especially for childbirth",
    },
  ];
            ...
            <table className="w-full bg-white rounded-2xl border border-ink-100">
              <thead>
                <tr className="bg-gradient-to-r from-accent-600 to-primary-600">
                  ...
                  <th className="text-center py-3 px-4 text-white font-semibold text-sm">
                    Points
                  </th>
                  <th className="text-left py-3 px-4 text-white font-semibold text-sm">
                    Meaning
              ...
              <tbody>
                {kootas.map((koota, i) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-center text-sm font-bold text-accent-600">
                      {koota.points}
                    </td>
        ...
        <div className="mt-8 max-w-6xl mx-auto">
          <Reveal delay={0.1}>
            <div className="bg-white rounded-2xl p-6 border border-ink-100 mb-6">
              <p className="text-ink-700 leading-relaxed">
                Mangal Dosha is formed when Mars is placed in certain houses
                related to marriage and domestic life. Astrologers carefully
                analyse birth charts to identify whether Mars is creating
                emotional instability, a temperament imbalance, aggression, or
                affecting marital compatibility.
              </p>
            </div>
          </Reveal>
              ...
              <div className="bg-white rounded-2xl p-6 border border-ink-100">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[1, 2, 4, 7, 8, 12].map((house) => (
                    <div
                      key={house}
                      className="bg-ink-50 rounded-lg p-3 text-center"
                    >
                ...
                <p className="text-xs text-ink-500 mt-3">
                  Professional astrologers also consider the Lagna and Moon
                  chart before final interpretation.
                </p>
              </div>
            </Reveal>
...
function ScoreInterpretation() {
  const scores = [
    {
      range: "Below 18",
      label: "Weak Compatibility",
      description:
        "May result in emotional differences, health issues, and challenges. Professional astrologers consider other factors before final conclusion.",
    },
    {
      range: "18 to 24",
      label: "Average Compatibility",
      description:
        "Requires considerable patience, understanding, and emotional maturity. Dashas and Navamsa Compatibility play an important role.",
    },
    {
      range: "24 to 32",
      label: "Good Compatibility",
      description:
        "Supports attraction, emotional understanding, and long-term stability in marital life.",
    },
    {
      range: "32 to 36",
      label: "Excellent Compatibility",
      description:
        "Strong mental and emotional alignment with smoother adjustment in marriage.",
    },
  ];
      ...
      <div className="container-8xl">
        ...
        <Reveal delay={0.4}>
          <div className="mt-6 bg-ink-50 rounded-2xl p-6 border border-ink-100 max-w-6xl mx-auto">
            <h3 className="text-lg font-bold text-ink-900 mb-2">
              Can You Marry With a Low Kundli Matching Score?
            </h3>
            <p className="text-ink-600 leading-relaxed">
              Yes, many couples have long-lasting marriages even with a low Guna
              Milan Score. This is because astrology includes much more than
              just the 36-point system. A weaker Guna Milan score can be
              adjusted with stronger 7th house compatibility, emotional
              maturity, mutual respect, and supportive Dashas.
            </p>
          </div>
        </Reveal>
      </div>
    ...
    <section className="py-16 bg-ink-50">
      <div className="container-8xl">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          <Reveal delay={0.1}>
            <div className="bg-white rounded-2xl p-6 border border-ink-100">
              <h3 className="text-xl font-bold text-ink-900 mb-3 text-center">
                North Indian
              </h3>
              <div className="p-4 bg-ink-50 rounded-xl">
                <p className="text-center font-semibold text-accent-600">
                  Ashtakoota Guna Milan
                </p>
                <p className="text-sm text-ink-500 text-center mt-1">
                  8 categories, 36 points system
                </p>
              </div>
        ...
        <Reveal delay={0.3}>
          <div className="mt-6 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-accent-50 to-primary-50 rounded-2xl p-6 border border-accent-200">
              <h3 className="text-lg font-bold text-ink-900 mb-2">
                Kundali Matching by Date of Birth vs by Name
              </h3>
              <p className="text-ink-600 leading-relaxed">
                <span className="font-semibold">By Date of Birth:</span> Uses
                exact birth details (date, time, place) to analyse the birth
                charts. This method helps study houses, planetary positions,
                dasha and navamsa charts, and deeper compatibility patterns.
              </p>
              <p className="text-ink-600 leading-relaxed mt-2">
                <span className="font-semibold">By Name:</span> A simplified
                method that uses the Moon sign and the nakshatra associated with
                the particular name. Useful when birth details are unavailable,
                but less accurate.
              </p>
            </div>
          </div>
  ...
  const features = [
    {
      ...
      description:
        "Precise calculations based on Vedic Astrology principles for accurate compatibility assessment.",
    },
    {
      icon: AlertCircle,
      title: "Mangal Dosha Analysis",
      description:
        "Detailed analysis of Mars placement and its impact on marital compatibility.",
    },
    {
      icon: Info,
      title: "Detailed Compatibility",
      description:
        "Comprehensive report covering all aspects of relationship compatibility.",
    },
    {
      icon: Zap,
      title: "AI-Powered Report",
      description:
        "Advanced AI algorithms combined with traditional astrological wisdom for accurate results.",
    },
  ];
          ...
          <div className="mt-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-accent-600 to-primary-600 rounded-2xl p-6 text-center text-white">
              ...
              <p className="text-sm opacity-90 mt-1">
                If you have questions about your score or other details,
                immediately chat with our expert astrologers for personalised
                guidance.
              </p>
            </div>
          </div>
      ...
      <div className="relative container-8xl text-center">
        ...
        <Reveal delay={0.1}>
          <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            Ready to find your{" "}
            <span className="gradient-text-light">perfect match?</span>
          </h2>
        </Reveal>

        <Reveal delay={0.2}>
          <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
            Check your marriage compatibility with our free online Kundali
            Matching tool and get instant, accurate results.
          </p>
        </Reveal>

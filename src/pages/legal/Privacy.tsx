  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Your privacy is <span className="gradient-text">our priority</span>
          </>
        }
        ...
        <div className="container-8xl max-w-4xl">
          <Reveal>
            <div className="p-6 rounded-2xl bg-ink-50 border border-ink-100 mb-12">
              <p className="text-sm text-ink-500">
                <strong className="text-ink-700">Last updated:</strong> January
                1, 2026
                <br />
                <strong className="text-ink-700">Effective date:</strong>{" "}
                January 1, 2026
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <p className="text-lg text-ink-600 leading-relaxed mb-12">
              This Privacy Policy explains how Jyotish AI ("we", "us", or "our")
              collects, uses, discloses, and safeguards your information when
              you use our astrology platform and services. We are committed to
              protecting your privacy and ensuring that your personal and
              astrological data is handled with the utmost care.
            </p>
          </Reveal>
                ...
                <div className="border-l-4 border-accent-500 pl-6">
                  ...
                  <ul className="space-y-3">
                    {section.content.map((item, j) => (
                      <li
                        key={j}
                        className="text-ink-600 leading-relaxed flex items-start gap-2"
                      >
          ...
          <Reveal>
            <div className="mt-16 p-8 rounded-2xl bg-gradient-to-br from-primary-50 to-accent-50 border border-primary-100">
              ...
              <div className="space-y-1 text-sm text-ink-700">
                <p>
                  <strong>Email:</strong> support@jyotishai.com
                </p>
                <p>
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <h2 className="text-3xl font-bold text-white sm:text-4xl text-balance">
              Your privacy is{" "}
              <span className="gradient-text-light">our commitment</span>
            </h2>
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Start your cosmic journey with confidence. Your data is safe,
              secure, and private.
            </p>

...
const values = [
  {
    ...
    desc: "We deliver genuine Vedic astrology and numerology insights rooted in ancient traditions.",
  },
  {
    icon: Star,
    title: "Accuracy First",
    desc: "Our calculations are rigorously tested by expert astrologers for precision and reliability.",
  },
  {
    icon: Shield,
    title: "Privacy & Trust",
    desc: "Your personal data and birth details are kept completely confidential and secure.",
  },
  {
    icon: Users,
    title: "Accessible for All",
    desc: "We make astrology simple, understandable, and accessible to everyone â€” free of charge.",
  },
];
...
const milestones = [
  {
    year: "2020",
    event:
      "Jyotish AI founded with a vision to make Vedic astrology accessible to everyone.",
  },
  {
    year: "2021",
    event:
      "Launched free Kundali generator, serving 50K+ users in the first year.",
  },
  {
    year: "2022",
    event:
      "Expanded to 10+ free astrology tools including Love Calculator and Panchang.",
  },
  {
    year: "2023",
    event:
      "Reached 500K+ users and added expert astrologer consultation services.",
  },
  {
    year: "2024",
    event:
      "Launched advanced calculators including Sade Sati and Kaal Sarp Dosh tools.",
  },
  {
    year: "2025",
    event:
      "Crossed 1M+ users with 15+ free astrology and numerology calculators.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Bringing <span className="gradient-text">Vedic Wisdom</span> to
            Everyone
          </>
        }
          ...
          <Reveal>
            <div className="h-full rounded-3xl p-10 bg-gradient-to-br from-primary-50 to-accent-50 border border-primary-100">
              ...
              <p className="text-ink-600 leading-relaxed">
                To democratize Vedic wisdom by giving everyone â€” regardless of
                their background â€” access to accurate, authentic, and
                easy-to-understand astrology and numerology tools. We believe
                that cosmic guidance should be free, private, and empowering.
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <div className="h-full rounded-3xl p-10 bg-gradient-to-br from-accent-50 to-primary-50 border border-accent-100">
              ...
              <p className="text-ink-600 leading-relaxed">
                A world where every person can understand their cosmic blueprint
                and use that knowledge to navigate life with clarity,
                confidence, and purpose â€” all through technology that makes
                ancient wisdom modern and accessible.
              </p>
            </div>
          </Reveal>
        </div>
                ...
                <div className="flex gap-6 pb-12 last:pb-0">
                  <div className="flex flex-col items-center">
                    ...
                    {i < milestones.length - 1 && (
                      <div className="w-0.5 flex-1 bg-ink-200 mt-4" />
                    )}
                  </div>
                  <div className="pt-3">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Reveal delay={0.1}>
              <div className="text-center p-6 rounded-2xl bg-ink-50 border border-ink-100 hover:border-accent-200 transition-all">
                ...
                <p className="text-sm text-ink-500">
                  All our calculators and tools are completely free to use with
                  no hidden charges.
                </p>
              </div>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="text-center p-6 rounded-2xl bg-ink-50 border border-ink-100 hover:border-accent-200 transition-all">
                ...
                <p className="text-sm text-ink-500">
                  Based on genuine Vedic astrology and numerology principles
            ...
            <Reveal delay={0.3}>
              <div className="text-center p-6 rounded-2xl bg-ink-50 border border-ink-100 hover:border-accent-200 transition-all">
                ...
                <p className="text-sm text-ink-500">
                  Your personal information and birth details are kept
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Explore our free astrology tools and start your journey of

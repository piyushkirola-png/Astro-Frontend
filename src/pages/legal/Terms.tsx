  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            The rules of <span className="gradient-text">our relationship</span>
          </>
        }
        ...
        <div className="container-8xl max-w-4xl">
          ...
          <Reveal>
            <p className="text-lg text-ink-600 leading-relaxed mb-12">
              Welcome to Jyotish AI. These Terms of Service ("Terms") govern
              your access to and use of Jyotish AI's astrology platform,
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Experience the wisdom of Vedic astrology with our free tools and

...
const caseStudies = [
  {
    ...
    solution: 'Implemented Jyotish  AI\'s smart routing engine to automatically route each payment to the gateway with the highest success rate for that transaction profile.',
    results: [
      { metric: '12%', label: 'Success rate improvement' },
      { metric: '40%', label: 'Reduction in failed transactions' },
      { metric: '3x', label: 'Faster checkout' },
    ],
    quote: 'Jyotish  AI cut our integration time from weeks to hours. The smart routing alone improved our success rate by 12%.',
  ...
  },
  {
    ...
    solution: 'Connected to Jyotish AI\'s single API and instantly gained access to 7 gateways supporting 180+ countries and multi-currency processing.',
    results: [
  ...
  },
  {
    ...
    solution: 'Jyotish  AI\'s automated settlement reconciliation matched every transaction against bank records automatically, with a manual override for edge cases.',
    results: [
      { metric: '0 days', label: 'Manual reconciliation' },
      { metric: '99.9%', label: 'Auto-match rate' },
      { metric: '24h', label: 'Settlement time' },
    ],
    quote: 'Settlement reconciliation used to take 3 days. With Jyotish  AI, it\'s automated and real-time.',

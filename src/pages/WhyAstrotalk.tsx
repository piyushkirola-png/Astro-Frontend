import { Zap, ShieldCheck, ArrowLeftRight, Globe, Users, Code2, TrendingUp, Clock, Headphones, Award, Star, Heart, Moon, Sun, Compass, Sparkles } from 'lucide-react';
...
const advantages = [
  { icon: Star, title: '500+ Expert Astrologers', desc: 'Connect with certified and experienced astrologers specializing in Vedic astrology, numerology, tarot, and more.' },
  { icon: Heart, title: 'Personalized Guidance', desc: 'Get customized insights and remedies based on your unique birth chart and life situation.' },
  { icon: ShieldCheck, title: '100% Private & Confidential', desc: 'Your personal details and astrological information are kept completely secure and private.' },
  { icon: Globe, title: '24/7 Availability', desc: 'Connect with astrologers anytime, anywhere â€” day or night, from any location.' },
  { icon: Users, title: '1M+ Happy Users', desc: 'Trusted by millions who have found clarity and direction through our astrological guidance.' },
  { icon: Sparkles, title: 'Free Tools & Calculators', desc: 'Access 15+ free astrology tools including Kundali, Love Calculator, Panchang, and more.' },
  { icon: Clock, title: 'Instant Consultations', desc: 'Get answers to your questions in minutes through chat, phone, or video consultations.' },
  { icon: TrendingUp, title: 'Accurate Predictions', desc: 'Based on authentic Vedic astrology principles and tested by expert astrologers.' },
  { icon: Headphones, title: 'Multiple Languages', desc: 'Consult in English, Hindi, Kannada, and other regional languages for better understanding.' },
  { icon: Award, title: 'Trusted Platform', desc: '4.8+ average rating from thousands of satisfied users across India and worldwide.' },
];
...
const categories = [
  { icon: Sun, title: 'Vedic Astrology', desc: 'Traditional Indian astrology based on planetary positions and birth charts.' },
  { icon: Moon, title: 'Numerology', desc: 'Understand your life path through the power of numbers and vibrations.' },
  { icon: Heart, title: 'Love & Compatibility', desc: 'Find harmony in relationships through astrological matching.' },
  { icon: Compass, title: 'Career & Finance', desc: 'Navigate your professional journey with cosmic guidance.' },
  { icon: Star, title: 'Remedies & Pooja', desc: 'Get personalized remedies for life\'s challenges and spiritual growth.' },
  { icon: Sparkles, title: 'Kundali & Horoscope', desc: 'Deep insights into your birth chart and life\'s journey.' },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={<>Why choose <span className="gradient-text">Jyotish AI</span> for astrological guidance?</>}
          ...
          <Reveal delay={0.1}>
            <div className="mt-12 bg-white rounded-2xl border border-ink-100 overflow-hidden">
              <div className="grid grid-cols-3 px-6 py-4 bg-ink-50 border-b border-ink-100">
                ...
                <div className="text-center text-sm font-bold text-primary-700">Jyotish AI</div>
      ...
      <section className="section-pad bg-ink-50">
        <div className="container-8xl">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              { name: 'Priya Sharma', quote: 'The free Kundali tool gave me amazing insights about my life path. The astrologers are truly knowledgeable.', rating: 5 },
              { name: 'Rahul Verma', quote: 'I found clarity in my career decisions through Jyotish AI. The consultations are affordable and accurate.', rating: 5 },
              { name: 'Ananya Patel', quote: 'The love calculator and compatibility tools helped me understand my relationship better. Highly recommended!', rating: 4 },
            ].map((t, i) => (
        ...
        <div className="relative container-8xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-ink-400 max-w-2xl mx-auto">
              Join millions who have found clarity, purpose, and direction with Jyotish AI.
            </p>

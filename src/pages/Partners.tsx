...
const partners = [
  {
    ...
    desc: "Global card payments with 135+ currencies, 3D Secure, and tokenization.",
    features: [
      "135+ currencies",
      "3D Secure 2.0",
      "Card tokenization",
  ...
  },
  {
    ...
    desc: "India's leading payment gateway with UPI, cards, net banking, and wallets.",
    features: [
      "UPI payments",
      "50+ net banking",
      "All wallets",
  ...
  },
  {
    ...
    desc: "High-success-rate gateway with instant payouts and bulk disbursements.",
    features: [
      "High success rate",
      "Instant payouts",
      "Bulk disbursals",
  ...
  },
  {
    name: "Adyen",
    color: "#0abf53",
    logo: "/partners/adyen.png",
    desc: "Enterprise-grade global payments with unified commerce and point-of-sale.",
    features: [
      "Unified commerce",
      "Global acquiring",
      "POS integration",
  ...
  },
  {
    ...
    desc: "Fast-growing gateway with strong presence in emerging markets.",
    features: [
      "Emerging markets",
      "EMI options",
      "BNPL support",
  ...
  },
  {
    name: "BennuPay",
    color: "#ff6b35",
    logo: "/partners/bennupay.png",
    desc: "Specialized gateway for high-risk verticals and cross-border payments.",
    features: [
      "High-risk support",
      "Cross-border",
      "Multi-currency",
  ...
  },
  {
    name: "Chargebee",
    color: "#1a1a1a",
    logo: "/partners/chargebee.png",
    desc: "Subscription billing and recurring payment management platform.",
    features: [
      "Recurring billing",
      "Dunning management",
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            7 gateways, <span className="gradient-text">one integration</span>
          </>
        }
            ...
            {[
              {
                icon: Plug,
                title: "Connect",
                desc: "Integrate with Jyotish using a single API call.",
              },
              {
                icon: Settings,
                title: "Configure",
                desc: "Enable the gateways you want from the dashboard.",
              },
              {
                icon: BarChart3,
                title: "Route",
                desc: "Our engine routes each payment to the best gateway.",
              },
              {
                icon: Webhook,
                title: "Receive",
                desc: "Get webhook notifications for every transaction.",
              },
            ].map((step, i) => (
